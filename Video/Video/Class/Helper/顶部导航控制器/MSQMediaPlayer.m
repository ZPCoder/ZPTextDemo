...
@interface MSQMediaPlayer ()<UIGestureRecognizerDelegate>

@property(nonatomic,strong)AVPlayer *player;
@property(nonatomic,strong)AVPlayerItem *playerItme;
@property(nonatomic,strong)AVPlayerLayer *playerLayer;

@property(nonatomic,strong)MSQMediaPlayerMaskView *maskView;
...
//        self.backgroundColor = [UIColor redColor];
        ...
        self.maskView = [[MSQMediaPlayerMaskView alloc]initWithFrame:CGRectMake(0, 0, frame.size.width, frame.size.height)];
