...
- (void)setupLastImageView:(UIImageView *)imageView
{
    ...
    startBtn.size = CGSizeMake(kScreenW/1.5, 40);
    startBtn.centerX = kScreenW/2;
    startBtn.centerY = kScreenH-150;
    [startBtn setTitle:@"开启微映像之旅＞＞＞" forState:UIControlStateNormal];
...
//    delegate.tab = [[TabBarViewController alloc] init];
//    MNavigationController *mNavCC = [[MNavigationController alloc] initWithRootViewController:delegate.tab];
    LeftViewController *left = [[LeftViewController alloc]init];
    RESideMenu *res = [[RESideMenu alloc]initWithContentViewController:delegate.mNavCC leftMenuViewController:left rightMenuViewController:nil];
    window.rootViewController = res;
    }
